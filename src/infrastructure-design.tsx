...
const InfrastructureDesign = () => {
  ...
  const infrastructureComponents = {
    ...
    keycloak: {
      ...
      description:
        "System-based JWT authentication service for secure API access",
      technologies: [
        "JWT Processing",
      ...
      redundancy: "Active-Active with load balancing",
      category: "security",
  ...
  const eventFlowSteps = [
    {
      step: "Healthcare Systems Update",
      description: "HIS systems update patient data (both NPHIES-compliant and non-compliant)",
      zone: "External",
      components: ["HIS (Compliant)", "HIS (Non-compliant)", "Other Systems"],
      critical: true,
    },
    {
      step: "Multi-Path Data Routing",
      description: "Compliant HIS → NPHIES, Non-compliant HIS → FHIR directly",
      zone: "Integration",
      components: [
        "Data Routing Logic",
        "Protocol Adapters",
    ...
    {
      step: "FHIR Central Processing",
      description: "FHIR receives data from multiple sources and standardizes to FHIR format",
      zone: "Application",
      components: ["Format Converter", "FHIR Server", "Data Validation"],
      critical: true,
    },
    {
      step: "Bidirectional Event Streaming",
      description: "FHIR publishes events to all subscribers via Redpanda",
      zone: "Streaming",
      components: ["Redpanda Cluster", "Schema Registry", "Event Routing"],
      critical: true,
    },
    {
      step: "Multi-Subscriber Consumption",
      description: "NPHIES, Sehhaty, and other systems consume FHIR events",
      zone: "Application",
      components: ["NPHIES Consumer", "Sehhaty Consumer", "Other Subscribers"],
      critical: true,
    },
    {
      step: "NPHIES Data Integration",
      description: "NPHIES receives standardized data from FHIR exchange layer",
      zone: "NPHIES",
      components: ["NPHIES Integration", "Data Processing", "Validation"],
      critical: true,
    },
    {
      step: "Healthcare Ecosystem Sync",
      description: "All healthcare systems synchronized through FHIR data exchange",
      zone: "All Systems",
      components: ["FHIR Exchange Hub", "System Synchronization", "Data Consistency"],
      critical: true,
    },
  ];
