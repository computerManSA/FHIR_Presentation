...
const InfrastructureDesign = () => {
  ...
  const infrastructureComponents = {
    ...
    'schema-registry': {
      ...
      technologies: ['Confluent Schema Registry', 'Avro schemas', 'Compatibility checks'],
    ...
    'kafka-connect': {
      ...
      technologies: ['Kafka Connect', 'Custom connectors', 'Source/sink patterns'],
      specifications: ['4 worker nodes', '8 vCPU', '16GB RAM', 'Plugin ecosystem'],
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 p-6">
      ...
      <div className="mb-8 p-6 bg-white rounded-lg border shadow-sm">
        <h2 className="text-xl font-bold mb-4">Infrastructure Best Practices</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
