  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 p-6">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">What is FHIR?</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Understanding the Fast Healthcare Interoperability Resources Standard
        </p>
      </header>
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">Poor</td>
                      <td className="px-4 py-3 text-sm text-gray-700">
                        Moderate
                      </td>
      ...
      <section id="core-concepts" className="mb-12">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Core Concepts</h2>
          </div>
          ...
          <div className="prose max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              and exchange. Understanding these concepts is key to successfully
              implementing FHIR-based solutions.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-purple-50 p-5 rounded-lg border border-purple-100">
                ...
                <p className="text-gray-700 mb-3">
                  ...
                  <strong>Resources</strong> - modular, clearly defined packages
                  of healthcare information. Each resource represents a coherent
                  healthcare concept, such as a Patient, Observation, or
                  Medication.
                </p>
                <p className="text-gray-700">
                  Resources have a defined structure with common metadata, a
                  human-readable section, and a structured data section. They
                  can be used individually or combined into larger documents or
                  messages.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-green-50 p-5 rounded-lg border border-green-100">
                ...
                <p className="text-gray-700 mb-3">
                  ...
                  standardization and customization. Extensions allow for adding
                  new elements to resources without changing their core
                  definition.
                </p>
                <p className="text-gray-700">
            ...
            <div className="bg-gray-50 p-5 rounded-lg border mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>
                      • <strong>CodeableConcept</strong>: Coded values with text
                    </li>
                    <li>
            ...
            <div className="bg-yellow-50 p-5 rounded-lg border border-yellow-100">
              ...
              <p className="text-gray-700 mb-3">
                FHIR incorporates standardized medical terminologies like SNOMED
                CT, LOINC, and ICD-10 through coded elements within resources.
                These terminologies provide consistent medical language across
                systems.
              </p>
              <p className="text-gray-700">
                The standard includes specific resources (CodeSystem, ValueSet,
                ConceptMap) for managing and using terminology content, enabling
                sophisticated terminology services that support clinical
                decision making, analytics, and interoperability.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                      ...
                      <li>• Cloud-based FHIR services (Google, AWS, Azure)</li>
                      <li>
      ...
      <section id="resources" className="mb-12">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800">FHIR Resources</h2>
          </div>

          <div className="prose max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              FHIR defines over 140 different resource types, each representing
              a specific healthcare concept. These resources are organized into
              logical categories based on their purpose and usage patterns.
            </p>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border border-blue-100">
                ...
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    />
                    <div>
                      <h4 className="font-medium text-gray-800">Observation</h4>
                      <p className="text-sm text-gray-600">
              ...
              <div className="border rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-white">
                  <div className="mb-3 p-2 border-l-4 border-blue-500 bg-blue-50">
                    ...
                    <p className="text-sm text-gray-600">
                      The specific type (e.g., Patient) and a unique identifier
                      for the resource
                    </p>
                  </div>
                  ...
                  <div className="mb-3 p-2 border-l-4 border-purple-500 bg-purple-50">
                    ...
                    <p className="text-sm text-gray-600">
                      Human-readable summary of the resource content, typically
                      in XHTML format
                    </p>
                  </div>
                  ...
                  <div className="p-2 border-l-4 border-orange-500 bg-orange-50">
                    ...
                    <p className="text-sm text-gray-600">
                      The unique data elements that define the resource content
                      (e.g., Patient has name, gender, birthDate)
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              ...
              read, update, delete, and search for resources, making it familiar
              to web developers and enabling straightforward integration with
              modern applications.
            </p>
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">POST</td>
                      <td className="px-4 py-3 text-sm font-mono text-xs text-gray-700">
                        /[type]
                      </td>
                      <td className="px-4 py-3 text-sm text-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    ...
                    <li>
                      • <strong>Common parameters</strong> across all resources
                      (e.g., _id, _lastUpdated)
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    ...
                    <li>
                      • <strong>Composite parameters</strong> combining multiple
                      fields
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-red-50 p-5 rounded-lg border border-red-100">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-3 rounded border">
                  <h4 className="font-medium text-gray-800 mb-2">$validate</h4>
                  <p className="text-sm text-gray-700">
            ...
            <div className="bg-purple-50 p-5 rounded-lg border border-purple-100">
              ...
              <div className="space-y-4">
                <div className="bg-white p-3 rounded border">
                  ...
                  <p className="text-sm text-gray-700">
                    Most organizations adopt FHIR incrementally, focusing first
                    on high-value use cases like patient access or specific data
                    exchange scenarios. This allows for learning and adjustment
                ...
                <div className="bg-white p-3 rounded border">
                  ...
                  <p className="text-sm text-gray-700">
                    ...
                    implementation, including reference servers (HAPI FHIR, FHIR
                    Server for Azure), client libraries, and testing frameworks.
                  </p>
                </div>
              </div>
            </div>
